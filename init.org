...
(spacemacs-org/init-org-bullets)
(org-bullets-mode t)
;; for some reason it turns off when my init loads, so turn it on.
#+END_SRC

Also:
#+BEGIN_SRC shell
ln -s init.org README.org
#+END_SRC
...
** COMMENT Fill-mode ---Word Wrapping
:PROPERTIES:
...
** COMMENT Fix spelling as you type ---thesaurus & dictionary too!
:PROPERTIES:
...
** COMMENT Using a Grammar & Style Checker
:PROPERTIES:
...
** COMMENT Lightweight Prose Proofchecking
:PROPERTIES:
...
** COMMENT Placeholder Text ---For Learning & Experimenting
:PROPERTIES:
...
** COMMENT Some text to make us smile
:PROPERTIES:
...
** COMMENT Unicode Input via Agda Input
:PROPERTIES:
...
** COMMENT Increase/decrease text size
:PROPERTIES:
...
** COMMENT Enabling CamelCase Aware Editing Operations
:PROPERTIES:
...
#+END_SRC
** COMMENT ~M-n,p~: Word-at-Point Navigation
:PROPERTIES:
...
#+END_SRC
** COMMENT Letter-based Navigation
:PROPERTIES:
...
** COMMENT [[https://revealjs.com/?transition=zoom#/][Reveal.JS]] -- The HTML Presentation Framework
:PROPERTIES:
...
** COMMENT Org-mode ⇐ HTML :Disabled:
:PROPERTIES:
...
** COMMENT Eldoc for Lisp and Haskell
:PROPERTIES:
...
extension of a file.
** COMMENT Version Control with SVN ---Using Magit!
...
** COMMENT What's changed & who's to blame?
:PROPERTIES:
...
** COMMENT Coding with a Fruit Salad: Semantic Highlighting
:PROPERTIES:
...
** COMMENT Text Folding with Origami-mode
...
** COMMENT Jump between windows using Cmd+Arrow & between recent buffers with Meta-Tab
:PROPERTIES:
...
(yankpad-reload)
#+END_SRC
* COMMENT Helpful Utilities & Shortcuts
:PROPERTIES:
...
* COMMENT Conclusion ---Why Configuration Files Should be Literate
:PROPERTIES:
